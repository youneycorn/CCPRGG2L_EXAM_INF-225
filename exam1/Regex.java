...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^(?=.*?[a-z])(?!.*[lgn]).{7,}$");
        ...
        pattern = Pattern.compile("^(?=\\w+@ymail.com).{15,}$");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("(https?):[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]", "");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("[^a-z A-Z 0-9]", "");
